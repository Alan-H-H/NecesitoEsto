  ...
  return (
    <main className="flex-1 space-x-6">
      <div className="flex w-full min-h-screen">
        <aside className="w-1/5 p-4 shadow-md">
          <h2 className="font-bold text-xl text-blue-600 mb-4">Configuración de Perfil</h2>
          <ul className="flex flex-col gap-2">
            <li
              className={`py-2 cursor-pointer flex flex-row flex h-[48px] items-center lg-rounded gap-2 rounded-md p-3 text-sm ${
                activeTab === "datosGenerales" ? "bg-sky-100 text-blue" : "hover:bg-sky-100 hover:text-blue-600 md:flex-none md:justify-start md:p-2 md:px-3"
              }`}
              onClick={() => setActiveTab("datosGenerales")}
            >

            <svg className="hover:text-blue-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} color={"#000000"} fill={"none"}>
            ...
            <li
              className={`py-2 cursor-pointer flex flex-row flex h-[48px] items-center lg-rounded gap-2 rounded-md p-3 text-sm ${
                activeTab === "seguridad" ? "bg-sky-100 text-blue" : "hover:bg-sky-100 hover:text-blue-600 md:flex-none md:justify-start md:p-2 md:px-3"
              }`}
            ...
            <li
              className={`py-2 cursor-pointer flex flex-row flex h-[48px] items-center lg-rounded gap-2 rounded-md p-3 text-sm ${
                activeTab === "demandas" ? "bg-sky-100 text-blue" : "hover:bg-sky-100 hover:text-blue-600 md:flex-none md:justify-start md:p-2 md:px-3"
              }`}
